    ...
    <div className="flex gap-6">
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-3 p-4 rounded-lg border border-border bg-bg-card">
          ...
          {/* Toggle live feed (mobile) */}
          <button
            onClick={() => setShowLiveFeed(!showLiveFeed)}
            className="lg:hidden px-3 py-1.5 rounded bg-zinc-800 border border-zinc-700 text-xs text-zinc-400"
          >
      ...
      >
        <div className="sticky top-24 space-y-4">
          ...
          <div className="rounded-lg border border-border bg-bg-card p-3 max-h-[calc(100vh-12rem)] overflow-y-auto">
      ...
      {showLiveFeed && (
        <div className="fixed inset-x-0 bottom-0 lg:hidden z-50 bg-bg p-4 border-t border-border max-h-[50vh] overflow-y-auto">

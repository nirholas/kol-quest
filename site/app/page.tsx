    ...
    <main className="max-w-4xl mx-auto px-6 py-16 animate-fade-in">
      ...
      <div className="text-center mb-20">
        <div className="inline-flex items-center gap-2 bg-bg-card border border-border rounded-full px-4 py-1.5 mb-6">
          ...
          <span className="text-xs text-zinc-400 font-medium">Open Source Research</span>
        </div>
        <h1 className="text-4xl sm:text-[3.25rem] font-extrabold text-white mb-5 tracking-tight leading-[1.1]">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-16">
        ...
        <StatCard value="434" label="Daily" sub="entries" />
        <StatCard value="435" label="Weekly" sub="entries" />
        <StatCard value="435" label="Monthly" sub="entries" />
      </div>
      ...
      <div className="relative bg-bg-card rounded-2xl p-6 sm:p-8 mb-16 border border-border overflow-hidden">
        ...
        <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-white font-semibold text-lg">Explore the full leaderboard</h2>
            <p className="text-zinc-500 text-sm mt-1">Sortable by profit, wins, losses, and win rate across all timeframes.</p>
          </div>
          <Link
            href="/leaderboard"
            className="inline-flex items-center gap-2 bg-buy hover:bg-buy-light text-black font-semibold px-5 py-2.5 rounded-xl transition-all duration-200 shadow-glow hover:shadow-glow-lg whitespace-nowrap text-sm"
          >
            Open Leaderboard
      ...
      <div className="relative bg-bg-card rounded-2xl p-6 sm:p-8 mb-16 border border-border overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-zinc-400 text-sm mb-5">
            ...
            <a href="https://gmgn.ai/follow" target="_blank" className="text-buy hover:text-buy-light underline underline-offset-2 decoration-buy/30">
              GMGN bulk import
            </a>
            . Paste the JSON from{" "}

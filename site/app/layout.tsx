    ...
    <nav className="sticky top-0 z-50 bg-bg-primary/90 backdrop-blur-xl border-b border-border">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <span className="text-zinc-500 text-xs hidden sm:block font-medium">472 wallets</span>
          <a
            href="https://github.com/nirholas/scrape-kolscan-wallets"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 bg-bg-card hover:bg-bg-hover border border-border rounded-lg px-3.5 py-1.5 text-sm text-zinc-300 hover:text-white transition-all duration-200"
          >
